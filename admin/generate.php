        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h4 class="m-0 font-weight-bold text-primary mt-3">Laporan Peminjaman</h4>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-success" href="print1.php?id_peminjaman=<?php echo $row['id_peminjaman']; ?>&tanggal_peminjaman=<?php echo $tanggal_peminjaman; ?>&tanggal_pengembalian=<?php echo $tanggal_pengembalian; ?>" target="_blank">Print</a>
                                            </td>
                                        </tr>
                                <?php
                                    }
