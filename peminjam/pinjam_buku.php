                ...
                <div class="col-sm-7">
                    ...
                    <form action="proses/tambah_pinjam.php" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" name="id_user" class="form-control" value="<?php echo $_SESSION['username']; ?>" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label"> Judul Buku </label>
                            <input type="text" name="judul" class="form-control" value="<?php echo $result['judul']; ?>" readonly>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tanggal_peminjaman" class="form-control" required id="tanggal_peminjaman" aria-describedby="emailHelp">
                                </div>
                            </div>
                            <div class="col">
                                <div class="mb-3">
                                    <label for="tanggal_pengembalian" class="form-label">Tanggal Pengembalian</label>
                                    <input type="date" name="tanggal_pengembalian" class="form-control" required readonly id="tanggal_pengembalian" aria-describedby="emailHelp">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
